    ...
    <>
        <section className="min-w-screen min-h-screen  px-3">
            <div className="flex flex-col justify-center lg:max-w-[800px] mx-auto padding-container gap-3">
                ...
                <p>Alternative systems are available for purchase, but they are often expensive and thus not available to the hobbyist. Therefore, I set out to create my own alternative timing system. The base of the system is using a Photoelectric through-beam production line sensor from SICK. I acquired this sensor second hand for cheap. This option allowed for accurate tracking upto a frequency of a 1000hz. This also meant that I did not have to create my own photo electrc through-beam sensor, which could prove to be inaccurate.  </p>
                ...
                <p>I refined the casing for 3 itterations, with additions in small holding pieces of plastic and casings for the battery packs. I also provided a stabilizer for the antenna, which allowed for potential water proofing in the future.</p>
                <Image className='py-5'src="/Prototype.jpg" alt="Second Prototype" width={800} height={600} />

                <p>Once completely finished and debugging the codes with a few hickups along the way, the final system works correctly. This system was validated by a slowmotion camera setup from multiple phones to validate the system at 960 fps. The system came within 0.003 seconds of accuracy on average after 10 tests. Most of the variations were actually caused by the sprinters error, where the hard crossed the beam before the sprinters body did, causing large deviations in the measurements. This also indicates the largest problem with through beam measurement compared to video capture, which is the inconsistent in hand positioning, which can cause some false positive measurements. Eitherway the system forms a proper alternative and mainly cheaper alternative than some of the competitors. This system is now used on my track and field club on a weekly basis.</p>
